...
date: "2022-07-17"
categories: [Expectation-Maximization, Clustering, Latent Variables]
description: "A deep dive into the Expectation-Maximization (EM) algorithm and its application in Gaussian and Multinomial mixture models."
---
...
```{mermaid caption="Organisational Structure" width="50%"}
%%{
    init: {
        'theme': 'base',
        'themeVariables': {
...
The whole EM algorithm can be referred to @algo-em.
