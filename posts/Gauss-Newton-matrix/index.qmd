...
date: "2021-04-12"
categories: [Optimisation, Machine Learning, Linear Algebra]
description: "Deriving the Gauss-Newton optimisation method and the properties of the Gauss-Newton approximation matrix."
---
...
$$
Note that in the following, we will omit the notation of the label $t_{i}$ from the loss $\ell(.)$ to make the notation uncluttered.
